    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=Yii::$app->params['backend_logo'].$sig->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=Yii::$app->params['backend_logo'].$sig->logo?>" alt="" width="350px" height="350px"/>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                                ...
                                <li>
                                    <a href="javascript:void(0);"
                                       rel="{gallery: 'gal1', smallimage: '<?=Yii::getAlias('@web')?>/images/preview_m3.jpg',largeimage: '<?=Yii::getAlias('@web')?>/images/preview_l3.jpg'}">
                                        <img src="<?=Yii::$app->params['backend_logo'].$gal->path?>"></a>
                                </li>
                            <?php endforeach;?>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li><span>上架时间：</span><?=date('Y-m-d',$sig->inputtime)?></li>
                    <li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
                <form action="/shop/notice" method="post" class="choose">
                    <ul>
